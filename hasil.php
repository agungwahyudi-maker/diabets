...
if ($alpha1==1) {
     ...
     $z1=$bdiabetes-($alpha1*($bdiabetes-$adiabetes)); 
}
...
if ($alpha5==1) {
     ...
     $z5=$bdiabetes-($alpha5*($bdiabetes-$adiabetes)); 
}
...
if ($alpha6==1) {
     ...
     $z6=$bdiabetes-($alpha6*($bdiabetes-$adiabetes)); 
}
...
if ($alpha7==1) {
     ...
     $z7=$bdiabetes-($alpha7*($bdiabetes-$adiabetes)); 
}
...
if ($alpha8==1) {
     ...
     $z8=$bdiabetes-($alpha8*($bdiabetes-$adiabetes)); 
}
...
if ($alpha14==1) {
     ...
     $z14=$bdiabetes-($alpha14*($bdiabetes-$adiabetes)); 
}
if ($alpha15==1) {
     $z15=0; 
} else if ($alpha15==0) {
     ...
     $z15=$bdiabetes-($alpha15*($bdiabetes-$adiabetes)); 
}
if ($alpha16==1) {
     $z16=0; 
} else if ($alpha16==0) {
     ...
     $z16=$bdiabetes-($alpha16*($bdiabetes-$adiabetes)); 
}
...
<body>
    <div class="container">
        ...
        <?php 
          if ($average<=0.5) {
               echo '<img src="img/aman.png">';
               echo '<p>Aman , Olahraga yang rutin yah</p>';
          }else if($average>0.5){
               echo '<img src="img/warning.png">';
               echo '<p><small>Kamu Mempunyai Resiko Gejala Diabetes Tinggi<br> Tetap semangat yah</small></p>';
          }else {
               echo 'ulang';
          }
          ?>
